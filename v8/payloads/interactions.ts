import type { APIGuildMember, APIUser, MessageFlags } from "./index.ts";
import type { RESTPostAPIWebhookWithTokenJSONBody } from "../rest/index.ts";
 ...
 */
export interface APIApplicationCommandSubCommandOptions
...
export type APIInteractionResponsePong = InteractionResponsePayload<
  APIInteractionResponseType.Pong
>;

export type APIInteractionResponseAcknowledge = InteractionResponsePayload<
  APIInteractionResponseType.Acknowledge
>;

export type APIInteractionResponseAcknowledgeWithSource =
  InteractionResponsePayload<APIInteractionResponseType.AcknowledgeWithSource>;
...
export type APIInteractionResponseChannelMessageWithSource =
...
interface InteractionResponsePayload<
  T extends APIInteractionResponseType,
  D = false,
> {
  type: T;
